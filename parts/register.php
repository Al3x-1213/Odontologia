    ...
    <div class="flex__container">
        <form method="POST" id="formulario" class="form"> <!-- action="../client/insert/insert.php" -->
            ...
            <div id="grupo_nacimiento" class="grupo">
                ...
                <div class="input-icon"><input type="date"  name="nacimiento" max="<?= $limiteFecha; ?>" class="input__form base"><i class="icon-warning display"></i> <i class="icon-checkmark1 display"></i></div>
                <div class="paragraf__error1 display">
