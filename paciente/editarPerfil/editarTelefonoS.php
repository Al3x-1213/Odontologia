...
<html lang="es">
    ...
    <body>
        ...
        $consulta = "SELECT telefono_2 FROM usuarios WHERE id_usuario = '$id'";
        ...
        <div class="card editTelefonoS">
            <div class="thead">
                <div class="row">
                    <div class="column">Télefono Secundario: </div>
                    <div class="mensaje">
                        <?php
                        include '../../client/updateTelefonoS.php';
                        ?>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="column">
                        <form method="POST">
                            <div class="inputs">
                                <div class="input">
                                    <input type="number" required name="telefono2" value="<?php echo $resultado['telefono_2']; ?>" class="inputUpdate">
                                </div>
                                <div class="button">
